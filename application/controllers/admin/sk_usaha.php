...
class Sk_usaha extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/sk_usaha',$data);
    ...
    public function tambah_sk_usaha()
    {
        ...
        $this->load->view('template_admin/header');
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/sk_usaha_form',$data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('template_admin/header');
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/sk_usaha_update',$data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        $this->sk_usaha_model->update_data($where, $data,'sk_usaha');
        $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    {
        $where = array('id_usaha' => $id);
        $this->sk_usaha_model->hapus_data($where,'sk_usaha');
        $this->session->set_flashdata('pesan','<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    public function permohonan(){
        ...
        $this->load->view('template_admin/header');
        $this->load->view('template_admin/sidebar');
        $this->load->view('permohonan_surat/sk_usaha',$data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function approve($id){
        ...
        $this->load->view('template_admin/header');
        $this->load->view('template_admin/sidebar');
        $this->load->view('permohonan_surat/sk_usaha_approve',$data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function approve_aksi(){
        ...
        redirect('admin/sk_usaha/permohonan');
    }
