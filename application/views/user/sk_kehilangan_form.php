<div class="container-fluid">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             $('#nama_penduduk').on('input',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('user/sk_kehilangan/get_id')?>",
                    dataType : "JSON",
    ...
    <form action="<?php echo base_url('user/sk_kehilangan/tambah_sk_kehilangan_aksi') ?>" method="post">
    ...
    <input type="hidden" name="akses" value="N">
        <center>
            <a href="<?php echo base_url('user/sk_kehilangan') ?>"><button type="button" class="btn btn-danger">Kembali</button></a>
