<div class="container-fluid">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             $('#nama_penduduk').on('input',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('user/sk_usaha/get_id')?>",
                    dataType : "JSON",
    ...
    <form action="<?php echo base_url('user/sk_usaha/tambah_sk_usaha_aksi') ?>" method="post">
    <input type="hidden" value="<?php echo $id ?>" name="id_user" class="form-control" style="width:275px;" readonly>
        <div class="table-responsive text-dark">
           ...
           <center>
                <a href="<?php echo base_url('user/sk_usaha') ?>"><button type="button" class="btn btn-danger">Kembali</button></a>
